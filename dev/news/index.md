...
- [`local_mock()`](https://testthat.r-lib.org/dev/reference/with_mock.md)
  and
  [`with_mock()`](https://testthat.r-lib.org/dev/reference/with_mock.md),
...
- It’s now much easier to create custom expectations, thanks to an
  ...
  [`pass()`](https://testthat.r-lib.org/dev/reference/fail.md) function
  to use in place of
  [`succeed()`](https://testthat.r-lib.org/dev/reference/succeed.md)
  ([\#2113](https://github.com/r-lib/testthat/issues/2113)), and
  revisions to how
  [`expectation()`](https://testthat.r-lib.org/dev/reference/expectation.md)
...
- Tests
  (i.e. [`test_that()`](https://testthat.r-lib.org/dev/reference/test_that.md),
  [`describe()`](https://testthat.r-lib.org/dev/reference/describe.md),
  and [`it()`](https://testthat.r-lib.org/dev/reference/describe.md)
  calls) can now be arbitrarily nested with a shared stack of
  descriptions so that the failures can show the full path through all
  subtests. Skips in subtests are now correctly scoped
...
- Updated vendored Catch framework from v1.9.6 (2017) to Catch2 v2.13.10
  (2022). This fixes compilation issues with the C++23 standard.
...
- [`test_dir()`](https://testthat.r-lib.org/dev/reference/test_dir.md),
  ...
  [`source_file()`](https://testthat.r-lib.org/dev/reference/source_file.md)
...
- [`try_again()`](https://testthat.r-lib.org/dev/reference/try_again.md)
  is now publicised, making it easier to test flaky code. We changed the
...
- `test_file(desc = ...)` (i.e. test filtering) no longer loses snapshot
  ...
  works with
  [`it()`](https://testthat.r-lib.org/dev/reference/describe.md), and
  can now be character vector in order to recursively filter subtests
  ([\#2118](https://github.com/r-lib/testthat/issues/2118)).
- [`test_that()`](https://testthat.r-lib.org/dev/reference/test_that.md)
  no longer warns about the absence of
...
- [`skip_on_os()`](https://testthat.r-lib.org/dev/reference/skip.md)
  gains an option `"emscripten"` of the `os` argument to skip tests on
...
- [`expect_no_failure()`](https://testthat.r-lib.org/dev/reference/expect_no_success.md),
  [`expect_no_success()`](https://testthat.r-lib.org/dev/reference/expect_no_success.md)
  and
...
- [`is_informative_error()`](https://testthat.r-lib.org/dev/reference/is_informative_error.md)
  and the `wrap` argument to
  [`test_dir()`](https://testthat.r-lib.org/dev/reference/test_dir.md)
  and friends are now defunct.
...
- [`it()`](https://testthat.r-lib.org/dev/reference/describe.md) now
  calls
...
- [`skip_on_bioc()`](https://testthat.r-lib.org/dev/reference/skip.md)
  now uses the documented environment variable (`IS_BIOC_BUILD_MACHINE`)
...
- [`test_path()`](https://testthat.r-lib.org/dev/reference/test_path.md)
  now works when called within helper files
...
- Improve way
  [`capture_output()`](https://testthat.r-lib.org/dev/reference/capture_output.md)
...
- New
  [`set_max_fails()`](https://testthat.r-lib.org/dev/reference/set_max_fails.md)
...
- New
  [`expect_snapshot_warning()`](https://testthat.r-lib.org/dev/reference/expect_snapshot_output.md)
  to match
...
- [`test_that()`](https://testthat.r-lib.org/dev/reference/test_that.md)
  no longer inappropriately skips when calling
...
- [`skip_on_os()`](https://testthat.r-lib.org/dev/reference/skip.md)
  gains an `arch` argument so you can also choose to skip selected
  architectures
  ([\#1421](https://github.com/r-lib/testthat/issues/1421)).

- [`test_that()`](https://testthat.r-lib.org/dev/reference/test_that.md)
  now correctly errors when an expectation fails when run interactively
  ([\#1430](https://github.com/r-lib/testthat/issues/1430)).

- [`test_that()`](https://testthat.r-lib.org/dev/reference/test_that.md)
  now automatically and correctly generate an “empty test” skip if it
  only generates warnings or messages (and doesn’t contain any
  expectations).

- [`testthat_tolerance()`](https://testthat.r-lib.org/dev/reference/testthat_tolerance.md)
...
- The vendored Catch code used for
  ...
  now uses a constant value for the stack size rather than relying on
...
- Failing expectations now include a backtrace when they’re not called
  ...
  [`test_that()`](https://testthat.r-lib.org/dev/reference/test_that.md)
  but are instead wrapped in some helper function
...
- [`auto_test_package()`](https://testthat.r-lib.org/dev/reference/auto_test.md)
...
- [`skip_if_not()`](https://testthat.r-lib.org/dev/reference/skip.md) no
...
- [`test_that()`](https://testthat.r-lib.org/dev/reference/test_that.md)
  now warns (3e only) if code doesn’t have braces, since that makes it
  hard to track the source of an error
...
- [`context()`](https://testthat.r-lib.org/dev/reference/context.md) is
  deprecated.
...
- [`expect_equivalent()`](https://testthat.r-lib.org/dev/reference/expect_equivalent.md),
  [`expect_reference()`](https://testthat.r-lib.org/dev/reference/expect_reference.md),
  [`expect_is()`](https://testthat.r-lib.org/dev/reference/expect_is.md)
  and
...
- [`setup()`](https://testthat.r-lib.org/dev/reference/teardown.md) and
  [`teardown()`](https://testthat.r-lib.org/dev/reference/teardown.md)
  are deprecated in favour of test fixtures. See
...
- [`expect_known_output()`](https://testthat.r-lib.org/dev/reference/expect_known_output.md),
  ...
  and
  [`expect_equal_to_reference()`](https://testthat.r-lib.org/dev/reference/expect_known_output.md)
...
- [`test_that()`](https://testthat.r-lib.org/dev/reference/test_that.md)
  now sets a number of options and env vars to make output as
  reproducible as possible
  ([\#1044](https://github.com/r-lib/testthat/issues/1044)). Many of
  these options were previously set in various places (in
  `devtools::test()`,
  [`test_dir()`](https://testthat.r-lib.org/dev/reference/test_dir.md),
  [`test_file()`](https://testthat.r-lib.org/dev/reference/test_file.md),
  or
...
- Catch C++ tests now provide detailed results for each test. To upgrade
  ...
  [`testthat::use_catch()`](https://testthat.r-lib.org/dev/reference/use_catch.md)
...
- [`test_that()`](https://testthat.r-lib.org/dev/reference/test_that.md)
  no longer triggers an error when run outside of tests; instead it
  produces a more informative summary of all failures, errors, warnings,
  and skips that occurred inside the test.

- [`test_that()`](https://testthat.r-lib.org/dev/reference/test_that.md)
  now errors if `desc` is not a string
  ([\#1161](https://github.com/r-lib/testthat/issues/1161)).

- [`test_file()`](https://testthat.r-lib.org/dev/reference/test_file.md)
  now runs helper, setup, and teardown code, and has the same arguments
  as
  [`test_dir()`](https://testthat.r-lib.org/dev/reference/test_dir.md)
...
- [`test_dir()`](https://testthat.r-lib.org/dev/reference/test_dir.md)
  now defaults `stop_on_failure` to `TRUE` for consistency with other
...
- [`capture_output()`](https://testthat.r-lib.org/dev/reference/capture_output.md)
  ...
  [`verify_output()`](https://testthat.r-lib.org/dev/reference/verify_output.md)
  use a new
  [`testthat_print()`](https://testthat.r-lib.org/dev/reference/capture_output.md)
...
- [`context_start_file()`](https://testthat.r-lib.org/dev/reference/context_start_file.md)
...
- New
  [`exp_signal()`](https://testthat.r-lib.org/dev/reference/expectation.md)
...
- Expectations can now be explicitly subclassed with
  [`new_expectation()`](https://testthat.r-lib.org/dev/reference/expectation.md).
...
- [`compare.numeric()`](https://testthat.r-lib.org/dev/reference/compare.md)
...
- Repair regression in
  [`test_rd()`](https://testthat.r-lib.org/dev/reference/test_examples.md)
...
- [`fail()`](https://testthat.r-lib.org/dev/reference/fail.md) and
  [`succeed()`](https://testthat.r-lib.org/dev/reference/succeed.md)
  gain `info` argument, which is passed along to
  [`expect()`](https://testthat.r-lib.org/dev/reference/expect.md).

- [`test_examples()`](https://testthat.r-lib.org/dev/reference/test_examples.md)
...
- [`skip()`](https://testthat.r-lib.org/dev/reference/skip.md) now
  reports reason for skipping as: `Reason: {skip condition}`
  ([@patr1ckm](https://github.com/patr1ckm),
  [\#868](https://github.com/r-lib/testthat/issues/868)).

- [`skip_if()`](https://testthat.r-lib.org/dev/reference/skip.md) and
  [`skip_if_not()`](https://testthat.r-lib.org/dev/reference/skip.md)
  now report `Reason: {skip condition} is TRUE` and
...
- `ProgressReporter`, the default reporter, now:
  ...
  - Automatically generates a context from the file name. We no longer
    ...
    [`context()`](https://testthat.r-lib.org/dev/reference/context.md)
    and instead encourage you to delete it, allowing the context to be
...
- New
  [`testthat_examples()`](https://testthat.r-lib.org/dev/reference/testthat_examples.md)
  and
  [`testthat_example()`](https://testthat.r-lib.org/dev/reference/testthat_examples.md)
...
- [`skip()`](https://testthat.r-lib.org/dev/reference/skip.md) now
  always produces a `message` of length 1, as expected elsewhere in
  testthat ([\#791](https://github.com/r-lib/testthat/issues/791)).
...
- “Failure: (unknown)”. The last release mistakenly failed to test bare
  ...
  [`test_that()`](https://testthat.r-lib.org/dev/reference/test_that.md).
  If you see “(unknown)” in a failure message, this is a failing
...
- [`skip_if()`](https://testthat.r-lib.org/dev/reference/skip.md) makes
  it easy to skip a test when a condition is true
...
- [`expect_known_output()`](https://testthat.r-lib.org/dev/reference/expect_known_output.md)
  replaces
  [`expect_output_file()`](https://testthat.r-lib.org/dev/reference/expect_output_file.md),
...
- New [`setup()`](https://testthat.r-lib.org/dev/reference/teardown.md)
  and
  [`teardown()`](https://testthat.r-lib.org/dev/reference/teardown.md)
...
- New
  ...
  and
  [`check_reporter()`](https://testthat.r-lib.org/dev/reference/default_reporter.md)
...
- Bare expectations notify the reporter once again. This is achieved by
  ...
  [`test_dir()`](https://testthat.r-lib.org/dev/reference/test_dir.md)
  and friends ([\#586](https://github.com/r-lib/testthat/issues/586)).

- [`auto_test()`](https://testthat.r-lib.org/dev/reference/auto_test.md)
  and
  [`auto_test_package()`](https://testthat.r-lib.org/dev/reference/auto_test.md)
...
- [`capture_output_lines()`](https://testthat.r-lib.org/dev/reference/capture_output.md)
  is now exported
  ([\#504](https://github.com/r-lib/testthat/issues/504)).

- [`compare.character()`](https://testthat.r-lib.org/dev/reference/compare.md)
  works correctly for vectors of length \> 5
  ([\#513](https://github.com/r-lib/testthat/issues/513),
  [@brodieG](https://github.com/brodieG))

- [`compare.default()`](https://testthat.r-lib.org/dev/reference/compare.md)
...
- [`find_test_scripts()`](https://testthat.r-lib.org/dev/reference/find_test_scripts.md)
...
- [`test_file()`](https://testthat.r-lib.org/dev/reference/test_file.md)
  now triggers a [`gc()`](https://rdrr.io/r/base/gc.html) after tests
  are run. This helps to ensure that finalisers are run earlier
  ([\#535](https://github.com/r-lib/testthat/issues/535)).

- [`test_path()`](https://testthat.r-lib.org/dev/reference/test_path.md)
  now generates correct path when called from within
...
[`expect()`](https://testthat.r-lib.org/dev/reference/expect.md) instead
...
- [`expect_more_than()`](https://testthat.r-lib.org/dev/reference/expect_less_than.md)
  and
  [`expect_less_than()`](https://testthat.r-lib.org/dev/reference/expect_less_than.md)
...
- [`takes_less_than()`](https://testthat.r-lib.org/dev/reference/takes_less_than.md)
  has been deprecated.

- [`not()`](https://testthat.r-lib.org/dev/reference/not.md) has been
...
- New functions
  [`capture_output()`](https://testthat.r-lib.org/dev/reference/capture_output.md),
  [`capture_message()`](https://testthat.r-lib.org/dev/reference/capture_condition.md),
  and
  [`capture_warnings()`](https://testthat.r-lib.org/dev/reference/capture_condition.md)
...
- [`source_test_helpers()`](https://testthat.r-lib.org/dev/reference/source_file.md)
  gets a useful default path: the testthat tests directory. It defaults
  to the
  [`test_env()`](https://testthat.r-lib.org/dev/reference/test_env.md)
  to be consistent with the other source functions
  ([\#415](https://github.com/r-lib/testthat/issues/415)).

- [`test_file()`](https://testthat.r-lib.org/dev/reference/test_file.md)
  now loads helpers in the test directory before running the tests
...
- [`make_expectation()`](https://testthat.r-lib.org/dev/reference/make_expectation.md)
  uses
  [`expect_equal()`](https://testthat.r-lib.org/dev/reference/equality-expectations.md).
...
- [`find_reporter()`](https://testthat.r-lib.org/dev/reference/find_reporter.md)
...
- [`with_reporter()`](https://testthat.r-lib.org/dev/reference/reporter-accessors.md)
  is used internally and gains new argument `start_end_reporter = TRUE`
  ([@krlmlr](https://github.com/krlmlr), 355).

- [`set_reporter()`](https://testthat.r-lib.org/dev/reference/reporter-accessors.md)
...
- [`compare.numeric()`](https://testthat.r-lib.org/dev/reference/compare.md)
  ...
  [`compare.POSIXt()`](https://testthat.r-lib.org/dev/reference/compare.md)
  for better reporting of datetime differences.

- [`expect_identical()`](https://testthat.r-lib.org/dev/reference/equality-expectations.md)
  and
  [`is_identical_to()`](https://testthat.r-lib.org/dev/reference/oldskool.md)
  now use
  [`compare()`](https://testthat.r-lib.org/dev/reference/compare.md) for
  more detailed output of differences
...
- testthat no longer muffles warning messages. If you don’t want to see
  ...
  (e.g. [`expect_warning()`](https://testthat.r-lib.org/dev/reference/expect_error.md)).
...
- Added
  [`skip_on_appveyor()`](https://testthat.r-lib.org/dev/reference/skip_on_travis.md)
...
- [`compare()`](https://testthat.r-lib.org/dev/reference/compare.md) is
  now documented and exported. Added a numeric method so when long
  numeric vectors don’t match you’ll see some examples of where the
  problem is ([\#177](https://github.com/r-lib/testthat/issues/177)).
  The line spacing in
  [`compare.character()`](https://testthat.r-lib.org/dev/reference/compare.md)
  was tweaked.
...
- New [`succeed()`](https://testthat.r-lib.org/dev/reference/succeed.md)
  expectation always succeeds.

- [`skip_on_travis()`](https://testthat.r-lib.org/dev/reference/skip_on_travis.md)
...
- It’s now possible to
  [`skip()`](https://testthat.r-lib.org/dev/reference/skip.md) a test
  with an informative message - this is useful when tests are only
  available under certain conditions, as when not on CRAN, or when an
...
- [`expect_named()`](https://testthat.r-lib.org/dev/reference/expect_named.md)
  and
  [`has_names()`](https://testthat.r-lib.org/dev/reference/oldskool.md)
  to check the names of a vector
  ([\#79](https://github.com/r-lib/testthat/issues/79))

- [`expect_more_than()`](https://testthat.r-lib.org/dev/reference/expect_less_than.md),
  [`is_more_than()`](https://testthat.r-lib.org/dev/reference/oldskool.md),
  [`expect_less_than()`](https://testthat.r-lib.org/dev/reference/expect_less_than.md),
  [`is_less_than()`](https://testthat.r-lib.org/dev/reference/oldskool.md)
...
- The [`not()`](https://testthat.r-lib.org/dev/reference/not.md)
...
- [`get_reporter()`](https://testthat.r-lib.org/dev/reference/reporter-accessors.md),
  [`set_reporter()`](https://testthat.r-lib.org/dev/reference/reporter-accessors.md)
  and
  [`with_reporter()`](https://testthat.r-lib.org/dev/reference/reporter-accessors.md)
  are now exported
...
- new [`fail()`](https://testthat.r-lib.org/dev/reference/fail.md)
  function always forces a failure in a test. Suggested by Richie Cotton
